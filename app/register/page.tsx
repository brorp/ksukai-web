...
import { ArrowRight, BadgeCheck, Lock, Mail, Phone, UserPlus } from "lucide-react";
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F4F8FF] p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-[780px] z-10 py-8">
        ...
        <Card className="shadow-[0_24px_60px_rgba(2,132,199,0.14)] border-slate-200/70 rounded-[2rem] overflow-hidden bg-white/95">
          ...
          <CardContent className="p-8">
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <div className="relative">
                            ...
                            <Input className="pl-10" placeholder="nama@email.com" {...field} />
                          </div>
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="S1 Farmasi / Profesi Apoteker" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <div className="relative">
                            ...
                            <Input className="pl-10" placeholder="08xxxxxxxxxx" {...field} />
                          </div>
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <div className="relative">
                            ...
                            <Input type="password" className="pl-10" placeholder="Minimal 6 karakter" {...field} />
                          </div>
                        </FormControl>
                        <FormMessage />
                      </FormItem>
            ...
            <div className="mt-7 text-center">
              ...
              <Link href="/login" className="text-sky-600 hover:text-sky-700 text-sm font-semibold">
                Login di sini
              </Link>
            </div>
          </CardContent>
